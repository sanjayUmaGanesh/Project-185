...
let data = {
    ...
    "2d": [
        {
            "id": "8",
            "image": require('../assets/crown-round.png')
        },
        {
            "id": "9",
            ...
            <View style={styles.container}>
                ...
                <View style={styles.headingContainer}>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.titleText1}>WEIRD</Text><Text style={styles.titleText2}>CROWNS</Text>
                    </View>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                        <Text style={styles.subheading1}>Try Our</Text><Text style={styles.subheading2}> Random filters</Text>
                    </View>
                </View>
                ...
                <View style={styles.framesContainer}>
                    <View style={styles.categoryContainer}>
                        ...
                        <TouchableOpacity style={this.state.selected == "pointed" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: `pointed` })}>
                            <Text>Pointed</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={this.state.selected == "with jewels" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: `with jewels` })}>
                            <Text>With Jewels</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={this.state.selected == "2d" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: `2d` })}>
                            <Text>2d</Text>
                        </TouchableOpacity>
